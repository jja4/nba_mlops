class Config:
    ...
    OUTPUT_TRAINED_MODEL_FILE_LR_DISCURDED = 'trained_models/discurded/model_best_lr'    # Trained Logistic Regression model file which has not a good accuracy. We will skip joblib extension
