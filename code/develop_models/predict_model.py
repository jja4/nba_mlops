...
X_train_full, X_test_full, y_train_full, y_test_full = load(
...
random_indices = np.random.choice(len(X_train_full), sample_size,
                                  replace=False)
...
random_indices_test = np.random.choice(len(X_test_full), 
                                       sample_size_test, replace=False)
